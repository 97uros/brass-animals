<?php
/**
 * Template Name: single location-band
 *
 */
...
<section class="singlecity">          
  <section class="hero">
    ...
    <?php else:
      ...
      <div class="hero__image" style="background: url('<?php bloginfo('template_url'); ?>/assets/images/<?php echo $parent_slug .".png"; ?>') center/cover no-repeat;">
    <?php endif; ?>
    <div class="container">
      <div class="row">
        <div class="col">
